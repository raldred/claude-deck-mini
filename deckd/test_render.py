...
def test_long_repo_is_truncated_not_crashing():
    img = render.paint_key(
        {"kind": "agent", "repo": "a" * 200, "branch": "b" * 200,
         "status": "thinking", "age": "just now"}, size=(80, 80))
...
def test_title_overflow_true_for_long_false_for_short():
    long_over, long_w = render.title_overflow(
        {"kind": "agent", "repo": "a" * 40, "status": "thinking", "age": "1m"}, size=(80, 80))
    short_over, short_w = render.title_overflow(
        {"kind": "agent", "repo": "ab", "status": "thinking", "age": "1m"}, size=(80, 80))
...
def test_marquee_paints_correct_size():
    img = render.paint_key(
        {"kind": "agent", "repo": "residently/feature-x", "status": "thinking", "age": "1m"},
...
def test_branch_overflow_true_for_long_false_for_short():
    long_over, long_w = render.branch_overflow(
        {"kind": "agent", "repo": "r", "branch": "feature/" + "x" * 40,
         "status": "thinking", "age": "1m"}, size=(80, 80))
    short_over, short_w = render.branch_overflow(
        {"kind": "agent", "repo": "r", "branch": "main", "status": "thinking", "age": "1m"},
        size=(80, 80))
...
def test_branch_overflow_false_when_no_branch():
    over, width = render.branch_overflow(
        {"kind": "agent", "repo": "r", "status": "thinking", "age": "1m"}, size=(80, 80))
...
def test_subagent_badge_paints_purple_when_running():
    img = render.paint_key(
        {"kind": "agent", "repo": "r", "branch": "b", "status": "thinking",
...
def test_no_badge_when_no_subagents():
    for spec in (
        {"kind": "agent", "repo": "r", "branch": "b", "status": "thinking",
         "age": "1m", "subagents": 0},
        {"kind": "agent", "repo": "r", "branch": "b", "status": "thinking", "age": "1m"},
    ):
        img = render.paint_key(spec, size=(80, 80))
